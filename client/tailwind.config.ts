  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        error: "hsl(var(--error))",
        info: "hsl(var(--info))",
        "agent-analyst": "hsl(var(--agent-analyst))",
        "agent-manager": "hsl(var(--agent-manager))",
        "agent-architect": "hsl(var(--agent-architect))",
        "agent-developer": "hsl(var(--agent-developer))",
        "agent-qa": "hsl(var(--agent-qa))",
        "status-planning": "hsl(var(--status-planning))",
        "status-building": "hsl(var(--status-building))",
        "status-testing": "hsl(var(--status-testing))",
